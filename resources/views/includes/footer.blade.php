        ...
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <linearGradient id="wave-gradient" x1="0" y1="0" x2="1440" y2="0"
                    ...
                    <stop stop-color="#0E86C9" />
                    <stop offset="1" stop-color="#0B5F96" />
                </linearGradient>
            </defs>
        </svg>
    </div>
        ...
        <div class="newsletter-section">
            <div class="newsletter-content">
                <div class="newsletter-text">
                    ...
                    <p class="newsletter-description">Dapatkan berita terkini langsung ke email Anda</p>
                </div>
...
<style>
    ...
    .social-link:hover {
        ...
        transform: translateY(-4px);
        box-shadow: 0 8px 20px rgba(14, 134, 201, 0.4);
    }
    ...
    .newsletter-input:focus {
        ...
        box-shadow: 0 0 0 3px rgba(14, 134, 201, 0.2);
    }
    ...
    .newsletter-button {
        ...
        align-items: center;
        gap: 0.5rem;
        box-shadow: 0 4px 15px rgba(14, 134, 201, 0.3);
    }

    .newsletter-button:hover {
        transform: translateY(-2px);
        box-shadow: 0 8px 25px rgba(14, 134, 201, 0.4);
    }
